...
const appCss = "/assets/styles-BAKQKyGr.css";
const Ctx$1 = reactExports.createContext(null);
const KEY$1 = "luvvu-theme";
...
function ThemeProvider({ children }) {
  ...
  reactExports.useEffect(() => {
    const stored = localStorage.getItem(KEY$1) || "system";
    setThemeState(stored);
    setResolved(applyTheme(stored));
    const mq = window.matchMedia("(prefers-color-scheme: dark)");
    const onChange = () => {
      const cur = localStorage.getItem(KEY$1) || "system";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Ctx$1.Provider, { value: { theme, setTheme, resolved }, children });
}
function useTheme() {
...
function AuthProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Ctx.Provider, { value: { user, login, logout }, children });
}
function useAuth() {
...
const heartLogo = "/assets/luvvu-heart-DSFT4lM_.png";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Страница не найдена" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/chat", className: "mt-6 inline-flex rounded-md bg-ember px-4 py-2 text-sm font-medium text-ember-foreground", children: "К чату" })
  ] }) });
}
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AuthProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, {}) }) });
}
function AppShell() {
  const { user } = useAuth();
  ...
  if (!user || isLogin) return /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {});
...
function AuthedLayout() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen w-full overflow-hidden bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between border-b border-border px-4 py-3 md:hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 font-display font-semibold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heartLogo, alt: "", className: "h-5 w-5" }),
          "Luvvu"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 min-h-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
    ] })
  ] });
}
function Sidebar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-5 py-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heartLogo, alt: "Luvvu", className: "h-10 w-10" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-xl font-semibold leading-none", children: "Luvvu" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: "тёплый AI рядом с тобой" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-1 space-y-1 px-3", children: items.map((it) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        to: it.to,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-sidebar-border p-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 truncate px-2 text-xs text-muted-foreground", children: user?.email }),
...
const $$splitComponentImporter$4 = () => import("./settings-CPn6ckk8.js");
const Route$4 = createFileRoute("/settings")({
  head: () => ({
    meta: [{
      title: "Настройки — Luvvu"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./connect-CnBG-_C1.js");
const Route$3 = createFileRoute("/connect")({
  head: () => ({
    meta: [{
      title: "Luvvu Connect — скоро"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./chat-CEd-4V4t.js");
...
const $$splitComponentImporter$1 = () => import("./business-Ddpx0oYy.js");
const Route$1 = createFileRoute("/business")({
  head: () => ({
    meta: [{
      title: "Luvvu Business — скоро"
    }]
  }),
...
function ComingSoon({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex h-full items-center justify-center overflow-hidden px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-md text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-ember ember-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-8 w-8 text-ember-foreground" }) }),
...
const $$splitComponentImporter = () => import("./index-CunSvQ2G.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Войди в Luvvu — тёплый AI для поддержки."
    }]
  }),
...
const ConnectRoute = Route$3.update({
  id: "/connect",
  path: "/connect",
  getParentRoute: () => Route$5
});
...
const BusinessRoute = Route$1.update({
  id: "/business",
  path: "/business",
  getParentRoute: () => Route$5
});
